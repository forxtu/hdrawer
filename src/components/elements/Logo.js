...
// styles
import fixAspectRatio from 'src/styles/mixins/fixAspectRatio';
...
const Logo = () => (
  <Layout>
    ...
    >
      ...
      <path
        d="M88.4,72c1-8.7,2.6-9.1,4.5-16.2c8-29-13.8-55.2-44.7-55.3l0,0h-0.1H48h-0.1l0,0l0,0h-0.1h-0.1h-0.1l0,0
